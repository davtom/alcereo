...
<body>
    <div>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <tr>
                <tr><td><label>Login:</label><span><?php echo $username_err; echo $registered; ?></span></td></tr>
                <tr><td><input type="text" minlength='3' name="username" value="<?php echo $username; ?>"></td></tr>
            <tr>
                <tr><td><label>Hasło:</label><span><?php echo $password_err; ?></span></td></tr>
                <tr><td><input type="password" minlength='3' name="password"></td>
            </tr>
            <tr>
                <tr><td><label>Imię:</label><span><?php echo $name_err; ?></span></td></tr>
                <tr><td><input type="text" name="name" value="<?php echo $name; ?>"></td></tr>
            <tr>
            <tr>
                <tr><td><label>Nazwisko:</label><span><?php echo $surname_err; ?></span></td></tr>
